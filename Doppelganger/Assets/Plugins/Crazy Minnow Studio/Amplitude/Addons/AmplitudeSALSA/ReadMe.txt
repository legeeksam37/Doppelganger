RELEASE NOTES & TODO ITEMS:
        2.0.0-beta:
            + initial release for using Amplitude with SALSA LipSync Suite v2.

LOCATION OF FILES:
	Assets\Crazy Minnow Studio\Amplitude\Addons\AmplitudeSALSA
...
SUPPORT: Contact assetsupport@crazyminnow.com. Provide:
    ...
    2) version numbers (OS, Unity, SALSA, Amplitude, etc.)
...
PURPOSE:
	This script creates a linkage between Amplitude and SALSA to provide WebGL
	lip-sync capability for SALSA LipSync v2.
REQUIREMENTS:
	1. To build for the WebGL platform, the current minimum Unity version is 2017.2.
KNOWN ISSUES: none.
